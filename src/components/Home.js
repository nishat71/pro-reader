      ...
      <div className='flex flex-col items-center justify-between lg:flex-row'>
        <div className='mb-10 lg:max-w-lg lg:pr-5 lg:mb-0'>
          <div className='max-w-xl mb-6 lg:mt-8'>
            <div>
              <p className='inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase bg-yellow-400 rounded-full'>On Sale!</p>
            </div>
          ...
          <div className='flex flex-col items-center md:flex-row'>
            <a href='/books'
              className='inline-flex items-center justify-center w-full h-12 px-6 mb-3 font-medium tracking-wide text-white transition duration-200 bg-blue-400 rounded shadow-md md:w-auto md:mr-4 md:mb-0 hover:bg-blue-700 focus:outline-none focus:shadow-outline'>
